...
def trackFace(me, info, w, pid, pError, pError2):
    ...
    ## Alt
    error2 = y - h//2                                                           # Evaluate the error
    ud = pid[0] * error2 + pid[1]*(error2 - pError2)                           # Evaluate the speed of yaw of the drone
    ud = int(np.clip(ud, -100,100))                                      # Clip the speed to the [-100,100] range
    ...
    return error, error2, fb, ud, speed
...
pError, pError2= 0,0                                                              # Initialize the error
...
while True:
    ...
    pError,pError2, fb, ud, speed= trackFace(me, info, w, pid, pError, pError2)              # Track the face : get the command values
