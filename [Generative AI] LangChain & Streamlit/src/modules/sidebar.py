...
class Sidebar:
    ...
    MAX_TOKENS_MIN_VALUE = 500
    MAX_TOKENS_MAX_VALUE = 5000
    MAX_TOKENS_DEFAULT_VALUE = 500
    MAX_TOKENS_STEP = 100
    ...
    def max_tokens_slider(self):
        max_tokens = st.slider(
            label="Max tokens",
            min_value=self.MAX_TOKENS_MIN_VALUE,
            max_value=self.MAX_TOKENS_MAX_VALUE,
            value=self.MAX_TOKENS_DEFAULT_VALUE,
            step=self.MAX_TOKENS_STEP,

        )
        st.session_state["max_tokens"] = max_tokens
        
    def show_options(self):
        with st.sidebar.expander("🛠️ Paramètrage", expanded=False):
            ...
            st.session_state.setdefault("max_tokens", self.MAX_TOKENS_DEFAULT_VALUE)
